...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    name = models.CharField('Nombres', max_length=255, default='name',blank=True, null=True)
    last_name = models.CharField('Apellidos',default='last name', max_length=255, blank=True, null=True)
